...
|---|---|---|---|---|
| 1 | files with the most code | 6k / 6k | 27k / 33k | 4.7× |
| 2 | codebase by language | 6k / 6k | 169k / 113k | **22.4×** |
| 3 | chunk counts per language | 5k / 5k | 53k / 47k | 8.6× |
| 4 | 10 largest source files | 6k / 6k | 20k / 27k | 3.9× |
| 5 | most code about topic A | 11k / 19k | 27k / 26k | 1.7× |
| 6 | most code about topic B | 6k / 6k | 23k / 41k | 5.0× |

**Class total: 6.5× fewer tokens.** Note the stability: the code-context
...
| # | Question shape | code-context (2 runs) | file tools (2 runs) | mean ratio |
|---|---|---|---|---|
| 7 | how records are appended | 89k / 54k | 118k / 118k | 1.6× |
| 8 | how scoring works | 54k / 39k | 98k / 68k | 1.8× |
| 9 | where fusion is implemented | 27k / 25k | 18k / 24k | 0.8× |
| 10 | crash recovery behavior | 94k / 86k | 142k / 59k | 1.1× |

**Class total: 1.4× fewer tokens**, with every answer carrying
...
converges in ~3 calls — but those content-rich responses cost roughly 2×
...
- Where file tools win, we say so. Single-run numbers per cell are
  ...
  aggregation table shows the baseline varying 8× between identical runs).
