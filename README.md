...
# Infino Subagents for Claude Code. Save 50% on your Anthropic bill. 

**Farm out retrieval work to small language models (SLMs) with better context. Same accuracy as frontier models while being 3x faster.**
